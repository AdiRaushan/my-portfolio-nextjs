...
import Mentorship from "@/components/grid-items/mentorship-box";
      ...
      <div className="flex-1 h-full max-w-md p-8">
        ...
        <div className="flex flex-col  h-full space-y-6 rounded-md">
          ...
          <div className="flex items-center justify-between gap-6 ">
            <a className="text-sm cursor-pointer w-full border flex items-center border-neutral-200 dark:border-neutral-800 py-2 px-3 rounded-md gap-1">
              {" "}
              <MapPin size={16} />
              {siteConfig.location}
            </a>
            ...
            <a
              className="text-sm cursor-pointer w-full border flex items-center border-neutral-100 dark:border-neutral-800 py-2 px-3 rounded-md gap-1 "
